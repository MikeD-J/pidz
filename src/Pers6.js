...
import persona from './persona6.jpg';
import planner from './planner.jpg';
import logo from './persona6.jpg';
...
export default function ProfilePopup() {
	...
	<i onClick={hideprofiel} class="fa fa-times" aria-hidden="true"></i>
		...
		<p class="name">Leroy Ankole</p>
		<div class="flexbox">
			<div class="flexobject">
				<p>NAW</p>	
				<p>Woonplaats: Someren</p>
				<p>Telefoonnummer:+31 6 74639201</p>
				<p>Email: leroyankoledeboy@hotmail.com</p>
				<p>Leeftijd: 36</p>
			</div>
			<div class="flexobject">
				<p>Bestanden</p>
			...
			<div class="flexobject">
				<p>Opleidingen</p>
				<p>Geneeskunde aan Universiteit van Eindhoven.</p>
				<p>Gehandicaptenzorg aan Universiteit van Eindhoven.</p>	
			</div>
			<div class="flexobject">
				<p>Opmerkingen</p>	
				<p>Ik ben begaafd in het omgaan met bejaarden.</p>
				<p>Ik ben vaardig in tilliften.</p>
			</div>
		</div>
		<div class="flexbox">
