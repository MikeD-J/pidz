...
export default function ProfilePopup() {
	...
	<i onClick={hideprofiel} class="fa fa-times" aria-hidden="true"></i>
		...
		<p class="name">Sander van Dongen</p>
		<div class="flexbox">
			<div class="flexobject">
				<p>NAW</p>	
				<p>Woonplaats: Helmond</p>
				<p>Telefoonnummer:+31 6 88563912</p>
			...
			<div class="flexobject">
				<p>Opleidingen</p>
				<p>Geneeskunde aan Universiteit van Nijmegen.</p>
				<p>Gehandicaptenzorg aan Universiteit van Nijmegen.</p>	
			</div>
			<div class="flexobject">
				<p>Opmerkingen</p>	
				<p>Ik weet mij goed te verdiepen in de patient gezien mijn geschiedenis.</p>
			</div>
		</div>
		<div class="flexbox">
