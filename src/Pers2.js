...
import persona from './persona2.jpg';
import planner from './planner.jpg';
import logo from './persona2.jpg';
...
export default function ProfilePopup() {
	...
	<i onClick={hideprofiel} class="fa fa-times" aria-hidden="true"></i>
		...
		<p class="name">Ferry de Vries</p>
		<div class="flexbox">
			<div class="flexobject">
				<p>NAW</p>	
				<p>Woonplaats: Someren</p>
				<p>Telefoonnummer:+31 6 72839217</p>
				<p>Email: ferryvries9@gmail.com</p>
				<p>Leeftijd: 55</p>
			</div>
			<div class="flexobject">
				<p>Bestanden</p>
